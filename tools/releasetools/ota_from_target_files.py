...
""" % bcb_dev)
  ...
  build_date = target_info.GetBuildProp("org.kowalski.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("ro.kowalski.device")
  manufacturer = target_info.GetBuildProp("ro.product.manufacturer")
  buildtype = target_info.GetBuildProp("org.kowalski.build_type")
